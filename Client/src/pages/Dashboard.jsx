    ...
    <div className="min-h-screen bg-gray-950 text-white flex flex-col">
      ...
      <nav className="bg-gray-950 border-b border-gray-800 px-6 py-3 flex items-center justify-between sticky top-0 z-50">
        <div className="flex items-center gap-8">
          <span className="text-purple-400 font-bold text-lg">⊞ PrepAI</span>
          <div className="hidden md:flex gap-2">
            {['Dashboard', 'Companies', 'Practice', 'Guides', 'Progress'].map((item, i) => (
              <button key={i} className="px-4 py-1.5 rounded-full text-sm text-gray-300 hover:text-white border border-gray-700 hover:border-gray-500 transition">
                {item}
              </button>
            ))}
          </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="w-8 h-8 rounded-full bg-purple-600 flex items-center justify-center text-sm font-bold">S</div>
